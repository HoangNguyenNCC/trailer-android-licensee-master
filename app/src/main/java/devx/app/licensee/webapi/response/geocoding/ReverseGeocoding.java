...
public final class ReverseGeocoding extends Geocoder {
    ...
    protected HttpUrl.Builder getUrlBuilder() {
        ...
        if (coordinate != null) {
            ...
            if (resultTypes != null)
                builder.addQueryParameter("result_type", TextUtils.join("|", resultTypes).toLowerCase());
            if (locationTypes != null)
                builder.addQueryParameter("location_type=", TextUtils.join("|", locationTypes).toLowerCase());
    ...
    /**
     * Set result types.
     * Available types found in {@link Result.AddressComponent AddressComponents}
     *
    ...
    /**
     * Set location types.
     * Available types found in LocationType LocationTypes
     *
     * @param types The types
     */
