...
class TrackingLicenseBottomSheetFragment(
    flag:String
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        txtCloseBottomSheet.setOnClickListener {
            (activity as TrailerTrackingActivity).dismissBottomSheet()
        }
        txtAddLicense.setOnClickListener {
            ...
            if(photoSelectedBitmap==null){
                ...
                (activity as TrailerTrackingActivity).dismissBottomSheet()
                (activity as TrailerTrackingActivity).addLicenseToserver()
            }
        }
        imgLicense.setOnClickListener {

            val bottomSheet = SelectDocumentBottomSheet("tracking")
